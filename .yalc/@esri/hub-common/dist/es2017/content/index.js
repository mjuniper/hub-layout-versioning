 ...
 * @returns new content
 */
export const setContentType = (content, type) => {
...
export const setContentHubId = (content, hubId) => {
 ...
 */
export const getContentSiteUrls = (content, siteModel) => {
 ...
 * @returns
 */
export const setContentSiteUrls = (content, siteModel) => {
