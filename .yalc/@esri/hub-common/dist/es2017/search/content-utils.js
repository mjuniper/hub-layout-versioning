 ...
 */
// TODO: Remove with _searchContent
export function convertPortalResponseToFacets(response, operation = "OR") {
 ...
 * @returns
 */
export function convertPortalItemResponseToFacets(response, operation = "OR", optionProp = "filters" // TODO: Remove with _searchContent and use `filters`
) {
    var _a;
