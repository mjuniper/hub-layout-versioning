import { isGuid, stripProtocol, getSiteById, lookupDomain, } from "..";
/**
 ...
 */
export function fetchSiteModel(identifier, hubRequestOptions) {
    let prms;
...
export function fetchSite(identifier, hubRequestOptions) {
