...
class OperationStack {
    ...
    startOperation(operation) {
        const op = util_1.cloneObject(operation);
    ...
    start(type, params) {
        const op = {
            type,
            id: get_with_default_1.getWithDefault(params, "id", util_1.createId(`${type}_`)),
            inputs: get_with_default_1.getWithDefault(params, "inputs", {}),
            cleanup: get_with_default_1.getWithDefault(params, "cleanup", "n/a"),
    ...
    finish(id, options) {
        ...
        if (op) {
            ...
            op.state = "completed";
            if (options) {
                op.output = util_1.cloneObject(options);
            }
        }
        else {
     ...
     */
    getCompleted() {
        return util_1.cloneObject(this.operations.filter(e => e.state === "completed"));
    }
    /**
     ...
     */
    getWorking() {
        return util_1.cloneObject(this.operations.filter(e => e.state === "working"));
    }
    /**
    ...
    serialize() {
        return {
            operations: util_1.cloneObject(this.getOperations())
        };
    }
}
exports.default = OperationStack;
...
//# sourceMappingURL=OperationStack.js.map