...
class ArcGISContext {
    ...
    get eventsConfig() {
        if (this._portalSelf) {
            return index_1.getProp(this._portalSelf, "portalProperties.hub.settings.events");
        }
    }
    /**
     ...
     */
    get hubEnabled() {
        return index_1.getWithDefault(this._portalSelf, "portalProperties.hub.enabled", false);
    }
    /**
    ...
    get communityOrgId() {
        if (this._portalSelf) {
            return index_1.getProp(this._portalSelf, "portalProperties.hub.settings.communityOrg.orgId");
        }
    }
    /**
    ...
    get communityOrgHostname() {
        if (this._portalSelf) {
            return index_1.getProp(this._portalSelf, "portalProperties.hub.settings.communityOrg.portalHostname");
        }
    }
    /**
