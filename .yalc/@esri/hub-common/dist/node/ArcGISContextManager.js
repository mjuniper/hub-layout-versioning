...
class ArcGISContextManager {
    ...
    constructor(opts) {
        ...
        logger_1.Logger.setLogLevel(this._logLevel);
        logger_1.Logger.debug(`ArcGISContextManager:ctor: Creating ${this.id}`);
        if (opts.properties) {
        ...
        if (opts.portal) {
            this._portalSelf = util_1.cloneObject(opts.portal);
        }
        if (opts.currentUser) {
    ...
    async initialize() {
        ...
        if (this._authentication && (!this._portalSelf || !this._currentUser)) {
            logger_1.Logger.debug(`ArcGISContextManager-${this.id}: Initializing`);
            ...
            try {
                ...
                logger_1.Logger.debug(`ArcGISContextManager-${this.id}: received portalSelf and currentUser`);
            }
            catch (ex) {
