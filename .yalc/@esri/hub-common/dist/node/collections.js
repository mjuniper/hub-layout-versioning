...
exports.collections = exports.getCollectionTypes = exports.getCollection = void 0;
const app = [
    "Application",
...
exports.getCollection = (type) => {
    ...
    return Object.keys(exports.collections).find((key) => {
        const collectionTypes = exports.collections[key];
 ...
 * @private
 */
exports.getCollectionTypes = (collection) => {
    if (!collection) {
        return;
    }
    const lowerCaseCollection = collection.toLocaleLowerCase();
    return exports.collections[lowerCaseCollection];
};
