...
import { createId, getProp, objectToJsonBlob, mergeObjects } from "../index";
 ...
 * @returns
 */
export async function createVersion(model, requestOptions, options) {
    ...
    await addItemResource(Object.assign(Object.assign({}, requestOptions), { id: getProp(model, 'item.id'), name: VERSION_RESOURCE_NAME, owner: getProp(model, 'item.owner'), params: { properties }, prefix, private: true, resource: versionBlob }));
