import { getProp, mergeObjects, objectToJsonBlob } from "../index";
import { getPrefix, getVersionData, VERSION_RESOURCE_NAME, VERSION_RESOURCE_PROPERTIES } from "./_internal";
...
export async function updateVersion(model, version, requestOptions) {
    ...
    await updateItemResource(Object.assign(Object.assign({}, requestOptions), { id: getProp(model, 'item.id'), name: VERSION_RESOURCE_NAME, owner: getProp(model, "item.owner"), params: { properties }, prefix, private: false, resource: versionBlob }));
    return version;
}
