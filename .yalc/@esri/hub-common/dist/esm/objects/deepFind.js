import { _isDate, _isFunction, _isObject, _isRegExp, } from "./_deep-map-values";
/**
 ...
 * @returns
 */
export function deepFindById(object, value) {
 ...
 * @returns
 */
export function deepFind(object, predicate) {
